...
//            }
//        }
//        Обратите внимание на то, что каждая итерация цикла означает выполнение задачи,
//        результат который передается через метод onDone()
//        функционального интерфейса OnTaskDoneListener.
//
//                Реализация
//        В классе Main в методе main() определите переменную
//        listener типа OnTaskDoneListener через лямбда-выражение:
//
//        OnTaskDoneListener listener = System.out::println;
...
//        и выведите информацию об этом в класс Main.
//        Для этого создайте новый функциональный интерфейс OnTaskErrorListener,
//        определите там метод onError().
...
//        Таким образом, в консоли после выполнения вашего кода все задачи,
//        кроме 33, должны закончиться успешно, а 33 - оповестит об ошибке.
//    }
//}